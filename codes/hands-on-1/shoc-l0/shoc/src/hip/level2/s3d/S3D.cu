...
//            hipFuncCachePreferL1));
    ...
    {
        CUDA_SAFE_CALL(hipEventRecord(start, 0));
        hipLaunchKernelGGL((ratt_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, tconv);

        hipLaunchKernelGGL((rdsmh_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_eg, tconv);

        hipLaunchKernelGGL((gr_base), dim3(blks2), dim3(thrds2), 0, s2, gpu_p, gpu_t, gpu_y,
                                               gpu_c, tconv, pconv);

        hipLaunchKernelGGL((ratt2_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, gpu_rb,
                gpu_eg, tconv);
        hipLaunchKernelGGL((ratt3_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, gpu_rb,
                gpu_eg, tconv);
        hipLaunchKernelGGL((ratt4_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, gpu_rb,
                gpu_eg, tconv);
        hipLaunchKernelGGL((ratt5_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, gpu_rb,
                gpu_eg, tconv);
        hipLaunchKernelGGL((ratt6_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, gpu_rb,
                gpu_eg, tconv);
        hipLaunchKernelGGL((ratt7_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, gpu_rb,
                gpu_eg, tconv);
        hipLaunchKernelGGL((ratt8_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, gpu_rb,
                gpu_eg, tconv);
        hipLaunchKernelGGL((ratt9_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rf, gpu_rb,
                gpu_eg, tconv);
        hipLaunchKernelGGL((ratt10_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_t, gpu_rklow, tconv);

        hipLaunchKernelGGL((ratx_kernel), dim3(blks), dim3(thrds), 0, s1, gpu_t, gpu_c, gpu_rf, gpu_rb,
                gpu_rklow, tconv);
        hipLaunchKernelGGL((ratxb_kernel), dim3(blks), dim3(thrds), 0, s1, gpu_t, gpu_c, gpu_rf, gpu_rb,
                gpu_rklow, tconv);
        hipLaunchKernelGGL((ratx2_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_c, gpu_rf, gpu_rb);
        hipLaunchKernelGGL((ratx4_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_c, gpu_rf, gpu_rb);

        hipLaunchKernelGGL((qssa_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_a);
        hipLaunchKernelGGL((qssab_kernel), dim3(blks), dim3(thrds), 0, s1, gpu_rf, gpu_rb, gpu_a);
        hipLaunchKernelGGL((qssa2_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_a);

        hipLaunchKernelGGL((rdwdot_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_wdot,
                rateconv, gpu_molwt);
        hipLaunchKernelGGL((rdwdot2_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_wdot,
                rateconv, gpu_molwt);
        hipLaunchKernelGGL((rdwdot3_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_wdot,
                rateconv, gpu_molwt);
        hipLaunchKernelGGL((rdwdot6_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_wdot,
                rateconv, gpu_molwt);
        hipLaunchKernelGGL((rdwdot7_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_wdot,
                rateconv, gpu_molwt);
        hipLaunchKernelGGL((rdwdot8_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_wdot,
                rateconv, gpu_molwt);
        hipLaunchKernelGGL((rdwdot9_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_wdot,
                rateconv, gpu_molwt);
        hipLaunchKernelGGL((rdwdot10_kernel), dim3(blks2), dim3(thrds2), 0, s1, gpu_rf, gpu_rb, gpu_wdot,
                rateconv, gpu_molwt);
        CUDA_SAFE_CALL(hipEventRecord(stop, 0));
        CUDA_SAFE_CALL(hipEventSynchronize(stop));
